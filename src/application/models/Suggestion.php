...
//-------------------------------------------------------------------------
    ...
    public function selectionRegime($id){
        $r = $this->db->query("select * from suggestion_regime where idObjectif='$id'");
        return $r->result();    
    }    
    ...
    public function selectionSport($id){
        $r = $this->db->query("select * from suggestion_sport where idObjectif='$id'");
        return $r->result();    
    }    
//-------------------------------------------------------------------------
