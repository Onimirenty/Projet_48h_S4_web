...
class Transaction extends CI_Model
{
    ...
    public function getPrixServiceIndividuel($idRegimePlat, $idPlat)
    {
        return $this->getRegimePlatCost($idRegimePlat, $idPlat);
    }
    public function calculateServicePrice($idRegimePlat, $idPlat)
    {
        ...
        $duree = $result->duree;
        $dureeEnJours = $duree;
        $prixServiceIndividuel = $this->getPrixServiceIndividuel($idRegimePlat, $idPlat);
    ...
    public function calculateServiceCost($service)
    {
        ...
        $serviceCost = ($regimePlatCost) * $service->duree;
